...
(function() {
  ...
  Server = (function(superClass) {
    ...
    Server.prototype.watch = function(paths, callback) {
      this.debug("Watching " + paths + "...");
      return this.watcher = chokidar.watch(paths, {
        ignoreInitial: true,
        ignored: this.config.exclusions,
        usePolling: this.config.usePolling
      }).on('add', this.filterRefresh.bind(this)).on('change', this.filterRefresh.bind(this) && callback && callback.bind(this)).on('unlink', this.filterRefresh.bind(this));
    };
